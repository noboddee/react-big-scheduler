...
var SchedulerData = function () {
  function SchedulerData() {
    ...
    var viewType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _index.ViewTypes.Day;
  ...
  _createClass(SchedulerData, [{
    ...
    key: 'setSchedulerWidth',
    value: function setSchedulerWidth(schedulerWidth) {
      if (schedulerWidth >= 0) {
        this.config.schedulerWidth = schedulerWidth;
      }
    }
  }, {
